...
const (
	HelloWorld_SayHello_FullMethodName  = "/skeleton.HelloWorld/SayHello"
	HelloWorld_SaveHello_FullMethodName = "/skeleton.HelloWorld/SaveHello"
)
...
type HelloWorldClient interface {
	...
	SaveHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloWorldClient) SaveHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, HelloWorld_SaveHello_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	...
	SaveHello(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedHelloWorldServer) SaveHello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _HelloWorld_SaveHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServer).SaveHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorld_SaveHello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).SaveHello(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloWorld_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "skeleton.HelloWorld",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HelloWorld_SaveHello_Handler,
		},
	},
